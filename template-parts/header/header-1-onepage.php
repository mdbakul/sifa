<?php 
   ...
   // Header Address Link
   $header_top_address_link = get_theme_mod( 'header_address_link', __( '#', 'sifa' ) );
   ...
   $header_language_switch = get_theme_mod( 'header_language_switch', __( 'false', 'sifa' ) );
   ...
   $sifa_menu_end = $sifa_header_right ? '' : 'd-flex justify-content-end';
                        ...
                        <div class="tp-header-contact-2 d-flex align-items-center">
                            ...
                            <div class="tp-header-contact-inner d-none d-xl-flex align-items-center">
                                ...
                                <div class="tp-header-contact-content">
                                    ...
                                    <span><a href="tel:<?php echo sifa_kses($phone_number_url); ?>"><?php echo esc_html( $header_top_phone ); ?></a></span>
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
