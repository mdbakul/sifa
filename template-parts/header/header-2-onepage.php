<?php 
	...
	*/
	 ...
	 // info
    $sifa_topbar_switch = get_theme_mod( 'header_topbar_switch', false );


     // Phone Number
   $header_top_phone = get_theme_mod( 'header_phone', __( '+8801310-069824', 'sifa' ) );

    // contact button
	$sifa_button_text = get_theme_mod( 'sifa_button_text', __( 'Make Request', 'sifa' ) );
   $sifa_button_link = get_theme_mod( 'sifa_button_link', __( '#', 'sifa' ) );

    // acc button
	$sifa_acc_button_text = get_theme_mod( 'sifa_acc_button_text', __( 'Login', 'sifa' ) );
   $sifa_acc_button_link = get_theme_mod( 'sifa_acc_button_link', __( '#', 'sifa' ) );

    $sifa_sticky_logo = get_theme_mod( 'header_sticky_logo', get_template_directory_uri() . '/assets/img/logo/logo-white.png' );
  // Header Address Text
  $header_top_address_text = get_theme_mod( 'header_address', __( '734 H, Bryan Burlington, NC 27215', 'sifa' ) );
  $header_address_link = get_theme_mod( 'header_address_link', __( '#', 'sifa' ) );
    
   // Button Text
   $header_top_button_switch = get_theme_mod( 'header_top_button_switch', false);
   $header_top_button_text = get_theme_mod( 'header_button_text', __( 'Donate Now', 'sifa' ) );

   // Button Text
   $header_top_button_link = get_theme_mod( 'header_button_link', __( '#', 'sifa' ) );
       // header right
   $sifa_header_right = get_theme_mod( 'header_right_switch', false );
   $sifa_menu_col = $sifa_header_right ? 'col-xl-7 col-lg-8 d-none d-lg-block' : 'col-xl-10 col-lg-8 d-none d-lg-block';
   $sifa_menu_end = $sifa_header_right ? '' : 'justify-content-end';
   // header search btn 
...
<header class="tp-header-area p-relative">
    <div class="tp-header-box p-relative">
        ...
        <div class="tp-header-wrapper-inner header__sticky p-relative">
            <?php if(!empty($sifa_topbar_switch)) : ?>
            <div class="tp-header-top d-none d-xl-flex">
                ...
                <div class="tp-header-top-right d-flex justify-content-end align-items-center">
                    <div class="header-social ">
                        <?php sifa_header_social_profiles(); ?>
                    </div>
                </div>
            </div>
            <?php endif; ?>
            <div class="tp-header-main-menu d-flex align-items-center justify-content-between">
                <div class="tp-main-menu d-none d-xl-block">
                    <nav class="tp-main-menu-content">
                        <?php sifa_onepage_menu_01(); ?>
                    </nav>
                </div>
                <?php if(!empty($sifa_header_right)) : ?>
                    ...
                    <div class="tp-header-contact d-xl-flex align-items-center d-none">
                        ...
                        <div class="tp-header-contact-inner d-flex align-items-center">
                            ...
                            <div class="tp-header-contact-content">
                                <p><?php echo esc_html__("Requesting A Call:","sifa") ?></p>
                                <span><a
