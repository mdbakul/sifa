<?php 
   ...
   $sifa_menu_col = $sifa_header_right ? 'col-xxl-6 col-xl-6 col-lg-8 d-none d-lg-block' : 'col-xxl-9 col-xl-9 col-lg-8 d-none d-lg-block text-end';
   $header_search_switch = get_theme_mod( 'header_search_switch', false );

   //Phone
   $header_top_phone = get_theme_mod( 'header_phone', __( '+880190678956', 'sifa' ) );
   $header_top_time = get_theme_mod( 'header_top_time', __( 'Sunday - Friday: 9 am - 8 pm', 'sifa' ) );
   $header_top_menu = get_theme_mod( 'header_top_menu', __( 'top menu', 'sifa' ) );
   ...
   // Header charity Text
   $header_top_charity_text = get_theme_mod( 'header_top_charity_text', __( 'Connect with our charity', 'sifa' ) );
      // header auth btn 
                        ...
                        <div class="col-xxl-7 col-xl-9">
                            <div class="tp-header-top-info-3">
                                <ul>
                                    ...
                                    <li>
                                        <a href=""><span><i
                                                    class="fa-solid fa-clock"></i></span><?php echo esc_html__("Sunday - Friday:","sifa") ?><b><?php echo esc_html( $header_top_time ); ?></b></a>
                                    </li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                        ...
                        <div class="col-xxl-5 col-xl-3">
                            <div class="tp-header-top-right-3 d-flex justify-content-end align-items-center">
                                ...
                                <div class="tp-header-top-support d-xxl-flex d-none">
                                    <?php echo sifa_kses( $header_top_menu ); ?>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
